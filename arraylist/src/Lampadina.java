...
public class Lampadina {
    ...
    /**
     * Costruttore che inizializza una lampadina (potenza di default a 5, luminosità 0, spenta)
     * @param nome nome lampadina
     * @param colore colore lampadina
     */
    public Lampadina(String nome, String colore) {
        this.nome = nome;
        this.colore = colore;
        this.acceso = false;
        this.potenza = 5.0f;
     ...
     * -> Se il valore è minore di 0, diventa 0
     * -> Se il valore è maggiore di 100, diventa 100
